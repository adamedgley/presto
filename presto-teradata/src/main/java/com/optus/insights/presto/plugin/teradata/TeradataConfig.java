...
public class TeradataConfig
{
    ...
    @Config("teradata.auto-reconnect")
    public TeradataConfig setAutoReconnect(boolean autoReconnect)
    {
    ...
    @Config("teradata.max-reconnects")
    public TeradataConfig setMaxReconnects(int maxReconnects)
    {
